...
const es = {
  ...
  modeHex: 'Ludo 6 Jugadores',
  modeHexDesc: 'Tablero hexagonal · solo, con amigos o 2v2v2',
  ...
  luckyEarn: 'Cada 6 o 1 suma +1 estrella · Cada compra sube +1 el precio de todos los dados',
  luckyArmed: 'armado — se usará en tu próxima tirada',
  luckyCancelHint: 'tócalo para quitarlo (te devuelve las estrellas)',
  luckyReady: 'listo',
  ranking: 'Ranking',
  teamFire: 'Equipo Fuego',
  teamForest: 'Equipo Bosque',
  mutePlayer: 'Silenciar jugador',
  throwMeme: 'Lanzar meme',
  throwMemeTo: 'Lanza un meme a',
  noMemesOwned: 'No tienes memes todavía. Cómpralos en el Inventario (desde la pantalla de inicio).',
  myMemes: 'Mis memes',
  unmutePlayer: 'Quitar silencio',
  diceSkinTitle: 'Tu dado',
  ...
  profilePoints: 'estrellas',
  profileId: 'ID',
  profilePin: 'PIN',
  profileCode: 'Código',
  profileCodeHint: 'Copia tu código y tu PIN para llevar tu cuenta (nombre y estrellas) a otro dispositivo o si cambia tu red.',
...
const en: typeof es = {
  ...
  modeHex: '6-Player Ludo',
  modeHexDesc: 'Hexagonal board · solo, friends or 2v2v2',
  ...
  luckyEarn: 'Every 6 or 1 earns +1 star · Each purchase raises every dice price by +1',
  luckyArmed: 'armed — it will be used on your next roll',
  luckyCancelHint: 'tap it again to cancel (stars refunded)',
  luckyReady: 'ready',
  ranking: 'Ranking',
  teamFire: 'Fire Team',
  teamForest: 'Forest Team',
  mutePlayer: 'Mute player',
  throwMeme: 'Throw meme',
  throwMemeTo: 'Throw a meme at',
  noMemesOwned: 'You have no memes yet. Buy them in the Inventory (from the home screen).',
  myMemes: 'My memes',
  unmutePlayer: 'Unmute player',
  diceSkinTitle: 'Your dice',
  ...
  profilePin: 'PIN',
  profileCode: 'Code',
  profileCodeHint: 'Copy your code and PIN to move your account (name and stars) to another device or if your network changes.',
