...
const es = {
  ...
  luckyHint: 'Compra un dado con tus ⭐: 50% de probabilidad de que salga tu número, 50% de que salga uno menor (el 1 cae en 2 o 3).',
...
const en: typeof es = {
  ...
  luckyHint: 'Buy a dice with your ⭐: 50% chance your number comes up, 50% a lower one does (the 1 falls to 2 or 3).',
