...
const es = {
  ...
  luckyHint: 'Compra un dado con tus ⭐: 30% de probabilidad de que salga tu número, 70% de que salga uno menor.',
...
const en: typeof es = {
  ...
  luckyHint: 'Buy a dice with your ⭐: 30% chance your number comes up, 70% a lower one does.',
